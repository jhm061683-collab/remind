...
const FAQS = [
  ...
  {
    question: "학원에 PC밖에 없는데, 아이들이 스마트폰 없이도 사용할 수 있나요?",
    answer:
      "리마인드는 웹앱 및 PWA 방식으로 설계되어 스마트폰, 태블릿, 학원 내 PC 등 기기를 가리지 않고 최적화된 화면을 제공합니다. 등원 후 학원 태블릿이나 공용 PC로도 충분히 입력 및 학습이 가능합니다.",
  },
  {
