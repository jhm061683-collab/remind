        ...
        contents: [
          {
            ...
            parts: [
              {
                text: "이 문제 사진을 디지털 문항으로 정리해 JSON으로 답하세요. 여러 문항이면 problems 배열로 분리하세요. 그래프·도형·표는 글로 설명하지 말고 원본 영역 좌표를 figures에 반환하세요. answer는 반드시 빈 문자열로 두세요. 정답을 옮기거나 풀지 마세요.",
              },
              ...imageParts,
            ],
          },
